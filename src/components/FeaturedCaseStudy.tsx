    ...
    <section className="py-28 md:py-40 section-divider">
      <div className="container">
        ...
        <Reveal className="mt-14">
          ...
          <Link
            to={`/work/${cs.slug}`}
            className="inline-flex items-center justify-center w-full sm:w-fit mt-10 font-mono text-[10px] uppercase tracking-wide bg-[#D1FE17] text-black rounded-[8px] px-6 py-3 hover:scale-105 transition-transform"
          >
            {extra.cta_label}
          </Link>
        </Reveal>
