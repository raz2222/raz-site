...
import { LayoutDashboard, Users, Layers, BookOpen, HelpCircle, FileText, GraduationCap, LogOut } from "lucide-react"
...
const LINKS = [
  ...
  { to: "/admin/course", label: "קורס", icon: GraduationCap },
]
...
export function AdminNav() {
  ...
  return (
    <>
      ...
      <nav
        className="md:hidden fixed bottom-0 left-0 right-0 z-40 grid grid-cols-7 border-t border-white/10 bg-background/95 backdrop-blur-xl"
