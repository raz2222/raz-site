...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="hidden md:flex fixed bottom-6 left-6 z-50 w-14 h-14 rounded-full bg-accent-gradient items-center justify-center shadow-lg hover:scale-105 transition-transform"
    >
