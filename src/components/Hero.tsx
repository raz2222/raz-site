  ...
  return (
    <section id="top" className="relative h-[100dvh] min-h-[600px] overflow-hidden flex flex-col justify-between">
      ...
      <div className="flex-1 flex flex-col justify-end px-5 md:px-12 pb-6">
        ...
        <button
          onClick={openModal}
          className="mt-8 inline-block w-fit font-mono text-[10px] font-bold uppercase tracking-wide bg-[#D1FE17] text-black rounded-[8px] px-6 py-3.5 hover:scale-105 transition-transform"
        >
          {hero.cta_label}
        </button>
        {hero.stats_line && (
