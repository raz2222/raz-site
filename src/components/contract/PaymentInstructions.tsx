  ...
  return (
    <div className="flex items-center justify-between gap-3 px-4 py-3">
      ...
      <button
        ...
        className="flex-none font-mono text-[10px] uppercase tracking-wide border border-white/25 rounded-full px-3 py-1.5 hover:border-[#D1FE17] transition-colors"
      >
        {copied ? "הועתק ✓" : "העתקה"}
      </button>
    </div>
        ...
        <div className="grid gap-4">
          ...
          {whatsappHref && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="font-mono text-[10px] uppercase tracking-wide underline underline-offset-4 text-dim hover:text-[#D1FE17] transition-colors w-fit"
            >
