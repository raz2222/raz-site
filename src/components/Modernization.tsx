    ...
    <section className="relative py-28 md:py-40 section-divider overflow-hidden">
      ...
      <div className="container relative">
        ...
        <Reveal delay={240}>
          <button
            onClick={openModal}
            className="inline-block mt-10 font-mono text-[10px] font-bold uppercase tracking-wide bg-[#D1FE17] text-black rounded-[8px] px-5 py-3 hover:scale-105 transition-transform"
          >
            {m.cta_label}
          </button>
        </Reveal>
