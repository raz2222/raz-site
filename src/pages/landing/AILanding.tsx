...
const HIGHLIGHTS = [
  { title: "פרסומות AI", text: "פרסומת ברמה קולנועית, בלי יום צילום — קונספט, הפקה ועריכה מקצועית.", video: "/videos/raz-showreel-2.mp4" },
  { title: "AI UGC", text: "תוכן שנראה כמו המלצה אישית אמיתית — ממיר יותר מפרסומת מוקפדת מדי.", video: "/videos/raz-showreel-4.mp4" },
  { title: "סרטוני מוצר", text: "הצגת מוצר בתנועה, בזוויות ובאיכות של סטודיו — בלי צילום סטודיו.", video: "/videos/raz-showreel-5.mp4" },
  { title: "קריאייטיבים לסושיאל", text: "מערך תוכן ויזואלי שוטף, לא פרויקט חד פעמי.", video: "/videos/raz-showreel.mp4" },
]

const PROCESS = [
  { n: "01", title: "בריף וקונספט", text: "מה המסר, למי זה מיועד, ואיפה זה יפורסם." },
  { n: "02", title: "כיוון ויזואלי", text: "בדיקת כמה כיווני עיצוב/סגנון לפני שממשיכים." },
  { n: "03", title: "נכסים עקביים", text: "דמות, מוצר או מיקום שחוזרים לאורך כל הסצנות." },
  { n: "04", title: "הפקה ועריכה", text: "יצירת הסצנות, ואז צבע, קצב וסאונד לפורמט הסופי." },
]
        ...
        <div className="px-5 md:px-12">
          <Reveal>
            <h1 className="font-display font-black text-[clamp(34px,6vw,76px)] leading-[1.05] tracking-tight max-w-4xl">
              פרסומת ברמה קולנועית. בלי יום צילום.
            </h1>
          </Reveal>
          <Reveal delay={100}>
            <p className="mt-6 max-w-xl text-dim text-lg md:text-xl leading-relaxed">
              הפקת תוכן ויזואלי בעזרת AI — סרטונים, פרסומות, תמונות מוצר — בעלות ובזמן נמוכים משמעותית.
            </p>
          </Reveal>
