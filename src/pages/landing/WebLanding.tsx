...
const FORMATS = [
  ...
  {
    title: "אתר אינטראקטיבי (פיתוח בעזרת AI)",
    body: "כשאתר רגיל פשוט לא מספיק. פיתוח מודרני בעזרת AI מאפשר תנועה, אנימציות ואינטראקציות שמוסיפות לחוויה בלי להפוך אותה לקרקס.",
    tags: ["AI", "אנימציות", "גלילה", "אינטראקציות", "חוויות דיגיטליות"],
  },
]
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start md:items-center justify-center overflow-y-auto bg-black/92 backdrop-blur-md px-4 py-6 md:py-8" onClick={onClose}>
      ...
      >
        ...
        <h2 className="font-display font-black text-[clamp(22px,4vw,34px)] leading-[1.15] tracking-[-0.04em] mb-4 md:mb-6 text-gradient-accent">יש לכם אתר לבנות?</h2>
