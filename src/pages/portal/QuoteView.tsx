          ...
          <div className="border border-white/15 rounded-lg p-5">
            ...
            <div className="flex flex-col gap-4">
              ...
              <button
                ...
                className="mt-2 w-fit font-mono text-[10px] font-bold uppercase tracking-wide bg-[#D1FE17] text-black rounded-full px-6 min-h-[48px] inline-flex items-center hover:scale-105 transition-transform disabled:opacity-50 disabled:hover:scale-100"
              >
