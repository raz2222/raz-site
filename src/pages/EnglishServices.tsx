    ...
    <section dir="ltr" className="pt-32 pb-28 md:pt-40 md:pb-40 text-left">
      <div className="container">
        ...
        <Reveal className="mt-20 text-center">
          <Link
            to="/en/contact"
            className="inline-block font-mono text-[10px] font-bold uppercase tracking-wide bg-[#D1FE17] text-black rounded-full px-8 py-4 hover:scale-105 transition-transform"
          >
            Start a project →
          </Link>
        </Reveal>
