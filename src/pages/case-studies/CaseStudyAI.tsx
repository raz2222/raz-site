    ...
    <>
      ...
      <section className="relative overflow-hidden section-divider py-20 md:py-28 text-center">
        ...
        <div className="container relative">
          ...
          <Reveal delay={80}>
            <Link to="/services/ai-content" className="inline-block font-mono text-sm font-bold uppercase tracking-wide bg-[#D1FE17] text-black rounded-[8px] px-7 py-3.5 hover:scale-105 transition-transform">
              לשירותי תוכן AI ←
            </Link>
          </Reveal>
        </div>
