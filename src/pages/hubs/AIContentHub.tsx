      ...
      <section className="relative min-h-[80dvh] overflow-hidden flex flex-col justify-center pt-24">
        ...
        <div className="container">
          ...
          <Reveal delay={160} className="mt-8">
            <Link to="/contact" className="inline-block font-mono text-[10px] uppercase tracking-wide bg-[#D1FE17] text-black rounded-full px-7 py-3.5 hover:scale-105 transition-transform">
              {hub.cta_label} ←
            </Link>
          </Reveal>
        </div>
