    ...
    <section id="work" className="py-28 md:py-40">
      <div className="container">
        ...
        <Reveal className="mt-12">
          <Link to="/en/work" className="inline-flex items-center justify-center w-full sm:w-fit font-mono text-sm font-bold uppercase tracking-wide bg-[#D1FE17] text-black rounded-[8px] px-6 py-3 hover:scale-105 transition-transform">
            View all work →
          </Link>
        </Reveal>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 mt-16">
          {PILLARS.map((p, i) => (
            <Reveal key={p.n} delay={i * 120}>
              ...
              <Link to="/en/services" className="inline-flex items-center justify-center w-full sm:w-fit mt-8 font-mono text-sm font-bold uppercase tracking-wide bg-[#D1FE17] text-black rounded-[8px] px-6 py-3 hover:scale-105 transition-transform">
                {p.cta}
              </Link>
            </Reveal>
          ))}
