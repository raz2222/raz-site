  ...
  return (
    <section id="top" className="relative h-[100dvh] min-h-[600px] overflow-hidden flex flex-col justify-between">
      ...
      <div className="flex-1 flex flex-col justify-end px-5 md:px-12 pb-6">
        ...
        <Link
          to="/en/contact"
          className="mt-8 inline-block w-fit font-mono text-[10px] font-bold uppercase tracking-wide bg-[#D1FE17] text-black rounded-full px-7 py-3.5 hover:scale-105 transition-transform"
        >
          Let&apos;s talk ←
        </Link>
      </div>
  ...
  return (
    <section className="py-28 md:py-40">
      <div className="container grid md:grid-cols-[1.2fr_1fr] gap-14 items-center">
        <div>
          <Reveal>
            <h2 className="font-display font-medium text-[clamp(32px,5vw,60px)] leading-[1.1] tracking-tight max-w-3xl text-gradient-accent text-shimmer">
  ...
  return (
    <section id="work" className="py-28 md:py-40">
      <div className="container">
        ...
        <Reveal>
          <h2 className="font-display font-medium text-[clamp(32px,5vw,60px)] leading-[1.1] tracking-tight text-gradient-accent text-shimmer">
        ...
        <Reveal className="mt-12">
          <Link to="/en/work" className="inline-flex items-center justify-center w-full sm:w-fit font-mono text-[10px] font-bold uppercase tracking-wide bg-[#D1FE17] text-black rounded-[8px] px-6 py-3 hover:scale-105 transition-transform">
            View all work →
          </Link>
        </Reveal>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 mt-16">
          {PILLARS.map((p, i) => (
            <Reveal key={p.n} delay={i * 120}>
              ...
              <h3 className="font-display font-medium text-2xl md:text-3xl mb-3 text-[#D1FE17]">{p.title}</h3>
              ...
              <Link to="/en/services" className="inline-flex items-center justify-center w-full sm:w-fit mt-8 font-mono text-[10px] font-bold uppercase tracking-wide bg-[#D1FE17] text-black rounded-[8px] px-6 py-3 hover:scale-105 transition-transform">
                {p.cta}
              </Link>
            </Reveal>
          ))}
    ...
    <section id="about" className="py-28 md:py-40">
      <div className="container">
        ...
        <div className="grid md:grid-cols-[1fr_1.2fr] gap-14 items-start">
          ...
          <div>
            <Reveal>
              <h2 className="font-display font-medium text-[clamp(32px,5vw,60px)] leading-[1.1] tracking-tight mb-6 text-gradient-accent text-shimmer">
                I'm Raz.
              </h2>
            </Reveal>
            <Reveal delay={100}>
  ...
  return (
    <section className="relative py-28 md:py-40 border-t border-white/10 overflow-hidden">
      ...
      <div className="container relative">
        <Reveal>
          <h2 className="font-display font-medium text-[clamp(30px,4.6vw,52px)] leading-[1.15] tracking-tight max-w-2xl text-gradient-accent text-shimmer">
        ...
        <Reveal delay={240}>
          <Link
            to="/en/contact"
            className="inline-block mt-10 font-mono text-[10px] font-bold uppercase tracking-wide bg-[#D1FE17] text-black rounded-full px-6 py-3 hover:scale-105 transition-transform"
          >
  ...
  return (
    <section id="contact" className="min-h-[70dvh] flex flex-col justify-center py-28">
      <div className="container text-center">
        <Reveal>
          <h2 className="font-display font-bold text-[clamp(38px,7.7vw,92px)] leading-[1.05] tracking-tight text-gradient-accent text-shimmer">
        ...
        <Reveal delay={150}>
          <Link
            to="/en/contact"
            className="inline-block mt-10 font-mono text-[10px] font-bold uppercase tracking-wide bg-[#D1FE17] text-black rounded-full px-8 py-4 hover:scale-105 transition-transform"
          >
            Start a Project →
          </Link>
        </Reveal>
